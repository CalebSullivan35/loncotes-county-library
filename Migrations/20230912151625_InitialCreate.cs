    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "222 street", "Caleb@Email.com", "Caleb", true, "Sullivan" },
                    { 2, "213 Ave", "Josh@Email.com", "Josh", true, "Dude" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, "David's Coffee Conspiracies", 1, null },
                    { 2, 5, "Romeo and Juliet", 1, null },
                    { 3, 5, "The Notebook", 1, null },
                    { 4, 2, "Jaws", 1, null },
                    { 5, 4, "David's buried Coffee Treasure!", 3, null },
                    { 6, 4, "History Textbook", 1, null },
                    { 7, 3, "Yard Sale ", 2, null },
                    { 8, 3, "Himalayas", 2, null },
                    { 9, 1, "Starfield", 1, null },
                    { 10, 2, "Scream", 1, null }
                });
